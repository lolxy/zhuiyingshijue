...
class HomeBaseController extends AppframeController {
	...
	function _initialize() {
		...
		$this->worktime1=$this->variable_model->where("id = 1")->getField('variablevalue');
		$this->worktime2=$this->variable_model->where("id = 3")->getField('variablevalue');
		$this->dianhua=$this->variable_model->where("id = 4")->getField('variablevalue');
		$this->telephone=$this->variable_model->where("id = 5")->getField('variablevalue');
		$this->qq1=$this->variable_model->where("id = 6")->getField('variablevalue');
		$this->qq2=$this->variable_model->where("id = 7")->getField('variablevalue');
		$this->qq3=$this->variable_model->where("id = 8")->getField('variablevalue');
		$this->lianxidianhua=$this->variable_model->where("id = 9")->getField('variablevalue');
		$this->address=$this->variable_model->where("id = 10")->getField('variablevalue');
		$this->addressen=$this->variable_model->where("id = 11")->getField('variablevalue');
		$this->telephone2=$this->variable_model->where("id = 12")->getField('variablevalue');
